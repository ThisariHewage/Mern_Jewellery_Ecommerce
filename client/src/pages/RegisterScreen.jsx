...
import { X, Mail, Lock, Eye, EyeOff, ArrowRight, Sparkles, User } from "lucide-react";
                ...
                <div className="bg-white/70 backdrop-blur-xl rounded-[2.5rem] border border-gray-100 p-8 sm:p-12 shadow-[0_20px_50px_rgba(0,0,0,0.05)] relative overflow-hidden group">
                    ...
                    <div className="flex justify-between items-start mb-12">
                        <div>
                            <div className="flex items-center gap-2 mb-2">
                                ...
                                <span className="text-[10px] uppercase tracking-[0.3em] text-gray-400 font-bold">New Member</span>
                            </div>
                            <h1 className="text-4xl sm:text-5xl font-serif tracking-tighter font-bold text-gray-900 leading-tight">
                                Join <span className="text-accent underline decoration-gray-100 underline-offset-8">Dewora</span>
                            </h1>
                        </div>
                    ...
                    <form onSubmit={submitHandler} className="space-y-5">
                        ...
                        <div className="group/input relative">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full bg-gray-50 border border-gray-200 rounded-2xl px-14 py-4 text-gray-900 placeholder:text-gray-400 focus:bg-white focus:border-accent/30 focus:shadow-lg focus:shadow-accent/5 outline-none transition-all duration-300 font-medium"
                                />
                            </div>
                        </div>
                        ...
                        <div className="group/input relative">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full bg-gray-50 border border-gray-200 rounded-2xl px-14 py-4 text-gray-900 placeholder:text-gray-400 focus:bg-white focus:border-accent/30 focus:shadow-lg focus:shadow-accent/5 outline-none transition-all duration-300 font-medium tracking-widest"
                                />
                                <button
                                    type="button"
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full py-5 mt-4 bg-gray-900 text-white rounded-2xl font-bold text-sm uppercase tracking-[0.2em] shadow-xl shadow-gray-900/10 hover:bg-black hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 disabled:opacity-50 disabled:scale-100 flex items-center justify-center gap-3 cursor-pointer group/btn"
                        >
                            {loading ? (
                    ...
                    <div className="mt-12 text-center">
                        <p className="text-gray-400 text-xs font-medium uppercase tracking-widest mb-4">Already a member?</p>
                        <Link
