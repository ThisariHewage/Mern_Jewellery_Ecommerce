        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
            ...
            <div className="bg-white rounded-3xl p-8 sm:p-12 shadow-sm border border-gray-100">
                ...
                <form onSubmit={submitHandler} className="space-y-8">
                    ...
                    <button
                        type="submit"
                        className="w-full py-4.5 bg-primary text-white border border-accent/25 uppercase tracking-widest font-bold text-sm hover:bg-black transition-all duration-300 active:scale-[0.98] mt-4 cursor-pointer shadow-md hover:shadow-lg"
                    >
                        Continue to Payment
                    </button>
                </form>
